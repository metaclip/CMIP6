...
for (i in 1:length(insts)) {
    ...
    cat("\n", file = con, append = TRUE)
    cat("\t\t<rdf:type rdf:resource=\"https://metaclip.org/datasource/datasource.owl#ModellingCenter\"/>\n",
        file = con, append = TRUE)
    cat("\t\t<rdf:type rdf:resource=\"https://metaclip.org/datasource/datasource.owl#DataProvider\"/>",
        file = con, append = TRUE)
    cat("\n", file = con, append = TRUE)
